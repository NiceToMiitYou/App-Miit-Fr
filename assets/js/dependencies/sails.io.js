        ...
        c.decodePacket = function( a ) {
            ...
            if ( a.charAt( 0 ) == "\ufffd" ) {
                ...
                for ( var d = 1, e = ""; d < a.length; d++ ) a.charAt( d ) == "\ufffd" ? ( b.push( c.decodePacket( a.substr( d + 1 )
                    .substr( 0, e ) ) ), d += Number( e ) + 1, e = "" ) : e += a.charAt( d );
                return b
            }
    ...
    if ( "undefined" != typeof window ) var swfobject = function() {
                    ...
                    if ( y.pv[ 0 ] > 0 ) {
                        ...
                        if ( g )
                            ...
                            var i = {},
                                ...
                                k = j.length;
                            for ( var l = 0; l < k; l++ ) j[ l ].getAttribute( "name" )
                                .toLowerCase() != "movie" && ( i[ j[ l ].getAttribute( "name" ) ] = j[ l ].getAttribute( "value" ) );
                            I( h, i, d, e )
                        } else J( g ), e && e( f )
                    } else {
                        U( d, !0 );
        ...
        function I( b, c, d, e ) {
            ...
            if ( g ) {
                ...
                var j = y.ie && y.win ? [ "Active" ].concat( "" )
                    .join( "X" ) : "PlugIn",
                    k = "MMredirectURL=" + h.location.toString()
                    .replace( /&/g, "%26" ) + "&MMplayerType=" + j + "&MMdoctitle=" + i.title;
        ...
        function U( a, b ) {
            ...
            t && P( a ) ? P( a )
                .style.visibility = c : T( "#" + a, "visibility:" + c )
        }
        ...
        var a = "undefined",
            ...
            y = function() {
                ...
                else if ( typeof h[ [ "Active" ].concat( "Object" )
                    .join( "X" ) ] != a ) try {
                    var s = new( window[ [ "Active" ].concat( "Object" )
                        .join( "X" ) ] )( d );

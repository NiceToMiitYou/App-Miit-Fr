window.ITConnect = (function() {
  ...
  function synchronize() {
    ...
    io.socket.post(apiPublicPrefix + '/synchronize', { token: lastestToken }, function(res) {
  ...
  return {
    ...
    chatroom: {
      ...
      send: function(chatroom, message, cb) {
        io.socket.post(apiPublicPrefix + '/chatroom/send', { message: message, chatroom: chatroom } , cb);
      }
    },
    ...
    question: {
      ...
      quizz: {
        ...
        questions: function(quizz, cb) {
          io.socket.post(apiPublicPrefix + '/question/quizz/questions', { quizz: quizz }, cb);
        },
      ...
      presentation: {
        ...
        like: function(question, cb) {
          io.socket.post(apiPublicPrefix + '/question/presentation/like', { question: question, like: true }, cb);
        },

        // Dislike a question
        dislike: function(question, cb) {
          io.socket.post(apiPublicPrefix + '/question/presentation/like', { question: question, like: false }, cb);
        }
      },
      ...
      slide: {
        ...
        question: function(slide, cb) {
          io.socket.get(apiPublicPrefix + '/question/slide/question', { slide: slide }, cb);
        },
    ...
    note: {
      ...
      delete: function(note, cb) {
        io.socket.post(apiPublicPrefix + '/note/delete', { note: note }, cb);
      },

      // send me a note
      send: function(note, cb) {
        io.socket.post(apiPublicPrefix + '/note/send', { note: note }, cb);
      }
    },

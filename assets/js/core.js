...
$( document )
    .ready( function() {
        ...
        $( ".folder-name" )
            .keypress( function( e ) {
                if ( e.which == 13 ) {
                    $( '.folder-input' )
                        .hide();
                    $( '<li><a href="#"><div class="status-icon green"></div>' + $( this )
                        .val() + '</a> </li>' )
        ...
        jQuery( '.page-sidebar li > a' )
            .on( 'click', function( e ) {
                ...
                if ( !$( this )
                    ...
                    $( ".page-sidebar .page-sidebar-wrapper ul li.active" )
                        .removeClass( "active" )
                    $( this )
                        .closest( "li" )
                        .addClass( "active" )
                    ...
                    $( ".nosider" )
                        .removeClass( "nosider" );
                    if ( href == "planning" || href == "quizz" || href == "ressources" || href == "wall" ) {
                        $( ".page-content" )
                            .addClass( "nosider" );
                    }
                    setTimeout( function() {
        ...
        $( '.grid .tools a.remove' )
            .on( 'click', function() {
                var removable = jQuery( this )
                    .parents( ".grid" );
                if ( removable.next()
                    .hasClass( 'grid' ) || removable.prev()
                    .hasClass( 'grid' ) ) {
                    jQuery( this )
                        .parents( ".grid" )
                        .remove();
        ...
        $( '.grid .tools .collapse, .grid .tools .expand' )
            .on( 'click', function() {
                var el = jQuery( this )
                    .parents( ".grid" )
                    .children( ".grid-body" );
        ...
        $( '.animate-number' )
            .each( function() {
                $( this )
                    .animateNumbers( $( this )
                        .attr( "data-value" ), true, parseInt( $( this )
                            .attr( "data-animation-duration" ), 10 ) );
            } );
...
function calculateHeight() {
    var contentHeight = parseInt( $( '.page-content' )
        .height(), 10 );
...
( function( $ ) {
    ...
    $.fn.condensMenu = function() {
        ...
        if ( windowWidth > 768 ) {
            if ( $( this )
                .hasClass( 'hide-sidebar' ) ) $( this )
                .toggleClass( 'hide-sidebar' );

            $( this )
                .toggleClass( 'condense-menu' );
            $( this )
                .find( '#main-menu' )
                .toggleClass( 'mini' );
        }
    ...
    $.fn.toggleFixedMenu = function() {
        ...
        if ( windowWidth > 768 ) {
            $( this )
                .toggleClass( 'menu-non-fixed' );
        }
    };

    $.fn.toggleHeader = function() {
        $( this )
            .toggleClass( 'hide-top-content-header' );
    };
    ...
    $.fn.layoutReset = function() {
        ...
        $( this )
            .removeClass( 'condense-menu' );
        $( this )
            .removeClass( 'hide-top-content-header' );
        if ( !$( 'body' )
            .hasClass( 'extended-layout' ) )
            $( this )
            .find( '#main-menu' )
            .removeClass( 'mini' );
    };

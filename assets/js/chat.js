...
$(document).ready(function() {	
    ...
    function initChatScroll() {
        ...
        var eleHeight = $(".chat-window-wrapper").height();
    ...
    $(".chat-area textarea").focusout(function () {
    	$(".chat-area .send-chat").fadeIn(200);
    })
});
	...
	function send_message(msg){
		...
		$('#messages-wrapper').slimScroll({ scrollTo : $(".chat-window-wrapper")[0].scrollHeight, animate: true });
	}	